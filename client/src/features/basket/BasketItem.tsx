...
export default function BasketItem({ item }: Props) {
    ...
    return (
        <section className="max-w-150 grid grid-cols-3 gap-3 items-center bg-zinc-100 dark:bg-zinc-900 p-4">
            ...
            <div className="flex justify-between py-3 px-2 rounded border-2 border-orange-400 dark:border-purple-700">
